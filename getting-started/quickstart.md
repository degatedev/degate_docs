...
The fastest path is email: enter your address, confirm the code from your inbox, set a password. Done. If you plan to hold higher-value assets, use **Create Wallet** or **Import Wallet** instead. Full walkthrough: [Create a Wallet](create-a-wallet.md).
...
You can also buy crypto directly in the app with a card, via the integrated fiat on-ramp (see [Integrations](../features/integrations.md)).
...
* Understand what you pay: [Fees](../fees.md)
* Understand who holds your keys (you do): [Security Overview](../security/security-overview.md)
