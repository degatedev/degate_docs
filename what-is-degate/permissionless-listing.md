...
Uniswap, as a pioneering protocol of the DEX concept, has proven the utility of a fully permissionless listing model to build asset diversity and ecological prosperity on the AMM track. DeGate builds on this concept but enables any pair to be traded with limit orders instead of market order swaps, making it easier for users to self list tokens on [DeGate DEX](https://orderbook.degate.com/?utm\_source=permissionlesslisting).
...
Learn how to self-list a token on [DeGate DEX](https://orderbook.degate.com/?utm\_source=permissionlesslisting) in the [token listing guide](https://docs.degate.com/v/product\_en/product-tutorial/listing-your-token-on-degate-dex).&#x20;
